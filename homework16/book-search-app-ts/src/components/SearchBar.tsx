...
export default function SearchBar({ handleSubmit, handleInputChange, input }: SearchBarProps) {
  ...
  const focusedSuggestionRef = useRef<HTMLLIElement>(null);
  ...
  useEffect(() => {
    if (inputData.length > 0) {
      const filtered = suggestions.filter((suggestion) =>
        suggestion.toLowerCase().includes(inputData.toLowerCase())
      );
